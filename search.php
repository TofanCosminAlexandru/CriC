...
<body>
 ...
 <div class="card">
    ...
    <a href="person-finder.html" class="btn btn-primary">Back</a>
    <a href="form.php" class="btn btn-primary">Create a new record</a> 
    </div>
 ...
 <div class="card">
    ...
    while($row = $q->fetch()): ?>
        ...
        <a href="person.php?id=<?php echo $row[0]; ?>&search=<?php echo $_REQUEST['search'] ?>" class="list-group-item active">
