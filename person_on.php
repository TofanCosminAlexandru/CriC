...
<div class="header-back" style="width: 100%; background: #616161; height: 70px; ">
	<a href="search_on.php?search=<?php echo $_REQUEST['search'];?>"><img src="images/back_arrow.png" width="54" height="54" style="padding: 6px;"></a>
</div>
...
<div class="w3-container">
  ...
  <div class="w3-card-4" style="width:60%; margin: auto;">
    ...
    <div class="w3-container">
      ...
      <?php $name=$row[1]; $lastName = $row[2]; $phoneNumber = $row[6]; $location = $row[7];?>
     <?php endwhile; ?>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <iframe src="../CriC/MAP/PersonFinderMap/index2.html?location=<?php echo $location;?>
                      &nume=<?php echo $name;?>&prenume=<?php echo $lastName;?>&numar=<?php echo $phoneNumber;?>" width="100%" height="455"></iframe>
        </div>
